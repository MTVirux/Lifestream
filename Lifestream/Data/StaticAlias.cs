...
public static class StaticAlias
{
    ...
    public static readonly CustomAlias OccultCrescent = EzConfig.DefaultSerializationFactory.Deserialize<CustomAlias>("""
        {"ExportedName":"Occult Crescent","Alias":"OC","Enabled":false,"Commands":[{"Kind":0,"Aetheryte":216,"Timeout":5000,"RequireUiOpen":false,"ExcelOnlyFirst":false},{"Kind":4,"Aetheryte":239,"Timeout":5000,"RequireUiOpen":false,"ExcelOnlyFirst":false},{"Kind":1,"Point":{"X":-36.835308,"Y":0.0,"Z":-12.507464},"Timeout":5000,"RequireUiOpen":false,"ExcelOnlyFirst":false},{"Kind":1,"Point":{"X":-74.80987,"Y":5.0,"Z":-15.057071},"Timeout":5000,"RequireUiOpen":false,"ExcelOnlyFirst":false},{"Kind":6,"DataID":1053611,"Timeout":5000,"RequireUiOpen":false,"ExcelOnlyFirst":false},{"Kind":9,"SelectOption":["<QuestDialogueText:custom/009/CtsMkdEntrance_00929:1:Value>","「蜃気楼の島 クレセントアイル：南征編」に突入する"],"StopOnScreenFade":true,"Timeout":5000,"RequireUiOpen":false,"ExcelOnlyFirst":true},{"Kind":9,"SelectOption":["<QuestDialogueText:custom/009/CtsMkdEntrance_00929:8:Value>"],"StopOnScreenFade":true,"Timeout":5000,"RequireUiOpen":false,"ExcelOnlyFirst":false},{"Kind":10,"Timeout":5000,"RequireUiOpen":false,"ExcelOnlyFirst":false}]}
        """);
